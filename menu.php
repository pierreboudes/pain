...
echo '<select name="annee_menu" id="choixannee_select" style="display:inline; width:100px;">';
ig_formselectannee($annee);
echo '</select>';
//echo '<input type="submit" id="choixannee_submit" value="OK" style="display:inline;width:40px;"/>';
echo '</form>'."\n";
?>
</li>
</ul>
